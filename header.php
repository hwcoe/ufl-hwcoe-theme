...
<?php
/*
 * Move Main Content down when user is logged in
 */
?>
...
<![endif]-->
    <script>
        ...
        ga('create', 'UA-5946660-1', 'auto');
        ga('send', 'pageview');

    </script>
</head>
  <body class="loading <?php if( is_home() || is_front_page() ){ echo 'home'; } ?>">
...
</svg>  <a href="#main" id="skip-link" class="visuallyhidden focusable">Skip to main content</a>
<div class="header">
<a href="/" class="logo"><img src="<?php ufl_athena_home_logo(); ?>"></a>
<?php if( get_field( 'theme_byline', 'option' ) ): ?>
  <a class="theme-byline-mobile" href="<?php echo get_site_url(); ?>"><?php the_field( 'theme_byline', 'option' ); ?></a>
<?php endif // theme_byline ?>
<div class="menu-wrap <?php ufl_athena_menu_style(); ?>">
    <?php ufl_athena_main_menu_output(); ?>
  	<div class="aux-menu-wrap">
    <?php if( has_nav_menu( 'top_menu' ) ): ?>
      <?php ufl_athena_top_menu(); ?>
    <?php else: ?>
  		<ul class="aux-nav">
        <?php if( get_field( 'theme_byline', 'option' ) ): ?>
          <li class="theme-byline"><?php the_field( 'theme_byline', 'option' ); ?></li>
        <?php endif // theme_byline ?>
  			...
  			<li><a href="https://directory.uf.edu">Directory</a></li>
      ...
      <a href="<?php the_field( 'audience_menu_link', 'option' ); ?>" class="cur-audience"><?php the_field( 'audience_menu_text', 'option' ); ?></a>
  			<span class="arw-right icon-svg"><svg><use xlink:href="<?php echo UFL_ATHENA_IMG_DIR ?>/spritemap.svg#arw-down"></use></svg></span>
      <?php if( has_nav_menu( 'audience_menu' ) ): ?>
        <?php ufl_athena_audience_menu(); ?>
      <?php else: ?>
	  		<ul>
      ...
      <?php endif // audience_menu ?>
	  	</div>
  	</div>
  	<a href="#" class="btn-show-aux">
			<span class="icon-svg icon-menu">
	    	<svg>
	      	<use xlink:href="<?php echo UFL_ATHENA_IMG_DIR ?>/spritemap.svg#menu"></use>
	    	</svg>
	    </span>
			<span class="icon-svg icon-close">
	    	<svg>
	      	<use xlink:href="<?php echo UFL_ATHENA_IMG_DIR ?>/spritemap.svg#close"></use>
	    	</svg>
	    </span>
	  </a>
    <form action="http://search.ufl.edu/search" method="get" class="search-wrap"> 
      <input type="hidden" name="source" id="source" value="web">
      <?php ufl_athena_search_domain(); ?>
      <input type="text" name="query" placeholder="Enter your search term here">
	  	<button type="submit" class="btn-search">
	  		<span class="icon-svg">
	      	<svg>
	        	<use xlink:href="<?php echo UFL_ATHENA_IMG_DIR ?>/spritemap.svg#search"></use>
	      	</svg>
	      </span>
	  	</button>
	  </form>
  ...
  <div class="mobile-dropdown-wrap"></div>
    ...
    <form action="http://search.ufl.edu/search" method="get" class="search-wrap mobile">
