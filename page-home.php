        ...
        <?php if( have_rows('page_modules') ): ?>
          <?php while ( have_rows('page_modules') ) : the_row(); ?>
            ...
            <?php if( get_row_layout() == 'featured_stories' ): ?>
                <?php include( UFL_ATHENA_INC_DIR . '/ufl-featured-story.php' ); ?>
            ...
            <?php if( get_row_layout() == 'statistics_module' ): ?>
                <?php include( UFL_ATHENA_INC_DIR . '/ufl-statistics.php' ); ?>
            ...
            <?php
              ...
              ?>
            <?php if( get_row_layout() == 'statistics_module' ): ?>
                <?php include( UFL_ATHENA_INC_DIR . '/ufl-statistics-standalone.php' ); ?>
            <?php endif // statistics_module ?>
            ...
            <?php if( get_row_layout() == 'profile_module' ): ?>
                <?php include( UFL_ATHENA_INC_DIR . '/ufl-profile.php' ); ?>
